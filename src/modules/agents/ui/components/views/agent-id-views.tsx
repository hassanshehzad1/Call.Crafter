/* This code snippet is a TypeScript React component that displays the details of a specific agent
based on the provided `agentId`. Here's a breakdown of what the code does: */
"use client";
...
export const AgentIdViewError = () => {
  return (
    <ErrorState
      title="Oops! Trouble Loading Your Agent"
